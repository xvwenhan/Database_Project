      ...
      <el-table-column label="操作">
        <template #default="scope">
          <el-button-group>
            ...
            <el-button size="mini" type="primary" icon="Edit" @click="handleEdit(row)">编辑</el-button>
            <el-button size="mini" type="danger" icon="Delete" @click="handleDelete(row)">删除</el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
